//! Macro for handling stream chunk results in compression operations
...
/// # async fn example() {
/// // let mut compressed_stream = Compress::zstd()
/// //     .on_chunk!(|chunk| {
/// //         Ok => chunk,
/// //         Err(e) => {
/// //             log::error!("Compression chunk error: {}", e);
/// //             return;
/// //         }
/// //     })
...
macro_rules! on_chunk {
    ...
    (|$chunk:ident| {
        ...
        |$chunk: Result<Vec<u8>, $crate::CompressionError>| -> Option<Vec<u8>> {
            match $chunk {
