...
mod tests {
    ...
    fn test_encapsulation_result_serialization() {
        let shared_secret = super::super::SharedSecret::new(
        ...
        let deserialized: serde_json::Value = serde_json::from_str(&json).expect("deserialization failed");
    ...
    fn test_verification_result_to_result() {
        ...
        let invalid_result = VerificationResult::new(
            super::super::SignatureAlgorithm::MlDsa65,
            false,
            None,
        );
