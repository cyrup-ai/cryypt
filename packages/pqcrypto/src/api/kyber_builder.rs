    ...
    T: cryypt_common::NotResult + Send + 'static,
{
    ...
    pub async fn generate_keypair(self) -> T {
        ...
        let result = real_kyber_generate_keypair(security_level).await;
        ...
        K: Into<Vec<u8>>,
    {
        ...
        let result = real_kyber_encapsulate(security_level, public_key).await;
        ...
        C: Into<Vec<u8>>,
    {
        ...
        let result = real_kyber_decapsulate(security_level, secret_key, ciphertext).await;
        ...
        K: Into<Vec<u8>> + Send + 'static,
    {
        ...
        tokio::spawn(async move {
            ...
            for public_key in keys {
                ...
                // Encapsulate individual shared secret
                let result = real_kyber_encapsulate(security_level, public_key).await;
...
async fn real_kyber_generate_keypair(security_level: SecurityLevel) -> Result<Vec<u8>> {
