    ...
    T: cryypt_common::NotResult + Send + 'static,
{
    ...
    pub async fn generate_keypair(self) -> T {
        ...
        let result = real_dilithium_generate_keypair(security_level).await;
        ...
        M: Into<Vec<u8>>,
    {
        ...
        let result = real_dilithium_sign(security_level, secret_key, message).await;
        ...
        S: Into<Vec<u8>>,
    {
        ...
        let result = real_dilithium_verify(security_level, public_key, message, signature).await;
        ...
        M: Into<Vec<u8>> + Send + 'static,
    {
        ...
        tokio::spawn(async move {
            ...
            for message in messages {
                ...
                let result = real_dilithium_sign(security_level, secret_key.clone(), message).await;
...
async fn real_dilithium_generate_keypair(security_level: SecurityLevel) -> Result<Vec<u8>> {
