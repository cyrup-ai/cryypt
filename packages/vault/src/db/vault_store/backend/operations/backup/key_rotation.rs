...
use super::super::super::super::{LocalVaultProvider, VaultEntry, KeyRotationStats};
...
impl LocalVaultProvider {
    ...
    pub(super) async fn update_session_key_after_rotation(&self, new_passphrase: &str) -> VaultResult<()> {
