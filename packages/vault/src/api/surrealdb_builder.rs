    ...
    T: cryypt_common::NotResult + Send + 'static,
{
        ...
        V: Into<Vec<u8>>,
    {
        ...
        let result = real_surrealdb_store(self.connection.0, key, value).await;
        ...
        K: Into<String>,
    {
        ...
        let result = real_surrealdb_retrieve(self.connection.0, key).await;
        ...
        V: Into<Vec<u8>> + Send + 'static,
    {
        ...
        tokio::spawn(async move {
            ...
            for (key, value) in items {
                ...
                let result = real_surrealdb_store(connection.clone(), key, value).await;
        ...
        K: Into<String> + Send + 'static,
    {
        ...
        tokio::spawn(async move {
            ...
            for key in keys {
                ...
                let result = real_surrealdb_retrieve(connection.clone(), key).await;
...
async fn real_surrealdb_retrieve(connection_path: String, key: String) -> VaultResult<Vec<u8>> {
    // Create VaultConfig with custom vault path
    let mut config = VaultConfig::default();
    config.vault_path = connection_path.into();
