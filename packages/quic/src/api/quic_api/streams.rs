//! QUIC Stream Handling and Internal Operations
//!
//! This module provides stream handling for QUIC connections, including send/receive
//! operations, streaming patterns, and internal helper functions.
