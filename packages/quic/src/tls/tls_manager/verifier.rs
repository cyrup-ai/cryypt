...
impl EnterpriseServerCertVerifier {
    ...
    pub async fn pre_validate_certificate(&self, cert_der: &[u8]) -> Result<(), super::super::errors::TlsError> {
        ...
        let parsed_cert = super::super::certificate::validation::parse_certificate_from_der(cert_der)?;
