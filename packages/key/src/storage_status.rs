...
impl StorageOperationStatus {
    ...
    pub fn to_key_error(&self) -> crate::KeyError {
        match self {
            ...
            StorageOperationStatus::KeyNotFound { key_id } => {
                crate::KeyError::KeyNotFound {
                    id: key_id.clone(),
                    version: 1,
                }
            },
            ...
            StorageOperationStatus::Unavailable { reason } => {
                crate::KeyError::StorageUnavailable {
                    reason: reason.clone(),
                }
            },
            StorageOperationStatus::ConnectionFailed { backend_type, details } => {
