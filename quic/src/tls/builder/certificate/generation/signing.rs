...
fn create_parameter_error(e: rcgen::RcgenError) -> CertificateGenerationResponse {
    CertificateGenerationResponse {
        success: false,
...
fn create_key_generation_error(e: rcgen::RcgenError) -> CertificateGenerationResponse {
    CertificateGenerationResponse {
        success: false,
        certificate_info: None,
        files_created: vec![],
...
fn create_dns_name_error(domain: &str, e: rcgen::RcgenError) -> CertificateGenerationResponse {
    CertificateGenerationResponse {
        success: false,
        certificate_info: None,
        files_created: vec![],
...
fn create_base_dns_name_error(base_domain: &str, e: rcgen::RcgenError) -> CertificateGenerationResponse {
    CertificateGenerationResponse {
        success: false,
        certificate_info: None,
        files_created: vec![],
...
fn create_self_signed_error(e: rcgen::RcgenError) -> CertificateGenerationResponse {
    CertificateGenerationResponse {
        success: false,
        certificate_info: None,
        files_created: vec![],
...
fn create_ca_key_parse_error(e: rcgen::RcgenError) -> CertificateGenerationResponse {
    CertificateGenerationResponse {
        success: false,
        certificate_info: None,
        files_created: vec![],
...
fn create_ca_issuer_error(e: rcgen::RcgenError) -> CertificateGenerationResponse {
    CertificateGenerationResponse {
        success: false,
        certificate_info: None,
        files_created: vec![],
...
fn create_ca_signing_error(e: rcgen::RcgenError) -> CertificateGenerationResponse {
    CertificateGenerationResponse {
        success: false,
        certificate_info: None,
        files_created: vec![],
