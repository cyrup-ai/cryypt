...
fn map_dao_error(e: DaoError) -> VaultError {
    match e {
...
impl SurrealDbVaultProvider {
    ...
    async fn put_impl(&self, key: String, value: VaultValue) -> VaultResult<()> {
    ...
    async fn put_if_absent_impl(&self, key: String, value: VaultValue) -> VaultResult<bool> {
    ...
    async fn put_all_impl(&self, entries: Vec<(String, VaultValue)>) -> VaultResult<()> {
...
// --- Namespace methods are part of the main impl block above ---
